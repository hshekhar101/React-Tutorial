...
function App() {
  ...
  //   Initial Render: The useEffect runs when the component is initially rendered, and it sets up event listeners on the 'inc' and 'dec' buttons.

  // Subsequent Renders: If the count variable changes during subsequent renders, the useEffect will run again due to the change in the count dependency. When it runs again, it cleans up the previous event listeners and sets up new ones.
  useEffect(() => {
    // useEffect is a hook which is brought in from react // It is used to run a function or a piece of code when the component is rendered
